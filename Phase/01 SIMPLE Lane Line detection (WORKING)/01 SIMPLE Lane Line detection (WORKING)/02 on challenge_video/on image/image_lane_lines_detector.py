...
image = cv2.imread('testchallenge1.png')
...
height = image.shape[0]         # 768      -> shape[0] = 720
width = image.shape[1]          # 1366     -> shape[1] = 1200
...
canny_image = cv2.Canny(gray_image, 150, 200)       # what's canny ?! canny is a filter of converting the image to lines and strokes
